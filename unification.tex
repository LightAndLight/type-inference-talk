...
\begin{frame}
  ...
  \infrule[T-lam]{
    \onslide<3->{\blueboxon{3}{\Gamma} ,\; \blueboxon{3,4}{x : \; \onslide<4->{??}} \vdash} \onslide<5->{\greenboxon{5}{e : T}}
  }{
...
\begin{frame}[t]
  ...
  \newcommand{\ntozero}{ \blueboxon{9,10}{ \changeto{10}{?^n}{?^0} } }
  \newcommand{\TtoBool}{ \blueboxon{57,58}{ \changeto{58}{T}{\Bool} } }

  \only<\lamslides>{
  \infrule[T-lam]{
    new(\ntozero) \andalso \Gamma , \; \xtobA : \; \ntozero \vdash
    \etoif \Rightarrow \TtoBool
  }{
    \Gamma \vdash \lam{ \xtobA }{ \etoif } \;\; \Rightarrow \;\; \ntozero \rightarrow \TtoBool
  }
  }
  ...
  \newcommand{\Btozero}{ \blueboxon{35,36}{ \changeto{36}{B}{?^0} } }
  \newcommand{\TOnetoBool}{ \changeto{44}{T_1}{\Bool} }
  \newcommand{\TOnetoBoolBlue}{ \blueboxon{43,44}{ \TOnetoBool } }
  \newcommand{\TOnetoBoolGreen}{ \greenboxon{43,44}{ \TOnetoBool } }
  \newcommand{\TTwotoBool}{ \blueboxon{51,52}{ \changeto{52}{T_2}{\Bool} } }

  \only<\ifslides>{
  \infrule[T-if]{
    \gammatogammabA \vdash \xtofalse \Rightarrow \TOnetoBoolBlue \andalso
    \gammatogammabA \vdash \ytotrue \Rightarrow \TTwotoBool \andalso
    \Btozero = \Bool \\
    \gammatogammabA \vdash \btob \Rightarrow \Btozero \andalso
    \phantom{ \gammatogammabA \vdash \ytotrue \Rightarrow \TTwotoBool } \andalso
    \TOnetoBoolBlue = \TTwotoBool
  ...
  \newcommand{\gammatogammabB}{ \blueboxon{25,26}{ \changeto{26}{\Gamma}{\Gamma,\; b : \; \blueboxon{31,32}{\ttozero}} } }

  \only<\varslides>{
    \infrule[T-var]{}{
      \gammatogammabB \vdash \xtobB \Rightarrow \greenboxon{31,32}{\ttozero}
    }
  }
