...
\begin{frame}
  ...
  \infrule[T-lam]{
    \onslide<3->{\blueboxon{3,4,5}{\Gamma ,\; x : \; \onslide<4->{??}} \vdash \blueboxon{3,4,5}{\onslide<5->{e :}}} \onslide<6->{\greenboxon{6}{T}}
  }{
...
\begin{frame}[t]
  ...
  \newcommand{\TTwotoBoolBlue}{ \blueboxon{51,52}{\TTwotoBool} }
  ...
  \infrule[T-if]{
    ...
    \gammatogammabA \vdash \ytotrue \Rightarrow \TTwotoBoolBlue \andalso
    \BtozeroRed = \Bool \\
    \gammatogammabA \vdash \btob \Rightarrow \BtozeroGreen \andalso
    \phantom{ \gammatogammabA \vdash \ytotrue \Rightarrow \TTwotoBoolBlue } \andalso
